...
<<<<<<< HEAD
    ...
    Route::get(
        'employer/{employer}/projects',
        [RecruiterDashboardController::class, 'getEmployerProjects']
    )->name('ajax.employer.projects');
    ...
    Route::post('/leads/update/{lead}', [RecruiterDashboardController::class, 'UpdateLeadOverview'])->name('leadsoverview.update');

    Route::get('/reports/leads/employer', [RecruiterDashboardController::class, 'leadsByEmployer'])->name('reports.leads.employer');

     Route::post('/recruiter/send-whatsapp/{id}', [RecruiterDashboardController::class, 'sendWhatsapp'])->name('recruiter.send.whatsapp');
