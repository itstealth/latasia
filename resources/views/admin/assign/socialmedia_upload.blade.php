...
@section('admin')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Social Media lead</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                                <li class="breadcrumb-item active">Social Media lead</li>
                            </ol>
                        </div>
    ...
    <div class="col-12">
        ...
        <!-- ================= UPLOAD SOCIAL MEDIA LEADS ================= -->
        <div class="card mb-4">
            <div class="card-body">
                <h4 class="card-title mb-3">Upload Social Media Leads</h4>

                <form action="{{ route('upload.social.leads') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h4 class="card-title mb-3">Assign Social Media Leads</h4>
