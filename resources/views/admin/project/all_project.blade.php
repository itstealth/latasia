        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">List Of Projects</h4>
                ...
                <div class="row mb-3 align-items-center">
                    <div class="col-md-6">
                        <h4 class="mb-0 fw-semibold">Project Management</h4>
                    </div>
                    <div class="col-md-6 text-end">
                        <a href="{{ route('add.project') }}" class="btn btn-primary">
                            <i class="fas fa-building me-1"></i> Add New Project
                        </a>
                    </div>
                </div>
                                    ...
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            @forelse ($projects as $key => $item)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td class="fw-semibold">{{ $item->employer->name }}</td>
                                                    ...
                                                    <!-- Status Badge -->
                                                    <td>
    <a href="{{ route('change.project.status', $item->id) }}"
       class="badge rounded-pill
       @if($item->status == 'active') bg-success
       @elseif($item->status == 'completed') bg-primary
