                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">List Of Employee</h4>
...
<div class="row mb-3 align-items-center">
    <div class="col-md-6">
        <h4 class="mb-0 fw-semibold">Employee Management</h4>
    </div>
    ...
    <div class="col-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <h5 class="card-title mb-3 text-muted">Employee List</h5>
                        ...
                        <tbody>
                            @forelse ($employees as $key => $item)
                                <tr>
                                    ...
                                    <!-- Status -->
                                    <td>
                                        <a href="{{ route('change.employee.status', $item->id) }}"
