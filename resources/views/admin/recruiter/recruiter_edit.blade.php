        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Edit Recruiter</h4>
                            <form action="{{ route('update.recruiter', $recruiter->id) }}" method="post" enctype="multipart/form-data"
                                class="auth-form">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="progress-basicpill-firstname-input">Recruiter
                                                Name</label>
                                            <input type="text" name="name" value="{{ $recruiter->name }}" placeholder="Recruiter Name"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="email" value="{{ $recruiter->email }}" class="form-control" placeholder="Email"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="progress-basicpill-firstname-input">Phone
                                                Number</label>
                                            <input type="text" name="phone" value="{{ $recruiter->phone }}" placeholder="Phone Number"
                                                class="form-control" id="progress-basicpill-lastname-input">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="address" value="{{ $recruiter->address }}" class="form-control" placeholder="Address"
                                                id="progress-basicpill-lastname-input">
                                        </div>
                                    </div>
