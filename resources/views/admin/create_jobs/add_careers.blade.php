				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<form action="{{ route('store.careers') }}" method="post" enctype="multipart/form-data" class="auth-form">
								@csrf
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input type="text" name="v_title"  class="form-control" id="progress-basicpill-lastname-input">
										</div>
									</div>
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input type="text" name="v_experience" class="form-control"  id="progress-basicpill-lastname-input">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input name="company_name" type="text" id="" class="form-control">
										</div>
									</div>
                                    <div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label" for="progress-basicpill-firstname-input">Location</label>
											<input name="location" type="text" id="" class="form-control">
										</div>
									</div>
                                ...
                                <div class="row">
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input name="v_type" type="text" id="" class="form-control">
										</div>
									</div>
                                    <div class="col-lg-6">
										<div class="mb-3">
											<label class="form-label" for="progress-basicpill-firstname-input">Keyword</label>
											<input name="keywords" type="text" id="" class="form-control">
										</div>
									</div>
                                ...
                                <div class="row">
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input name="v_image" type="file" class="form-control" placeholder="" id="image">
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="form-control" id="elm1" name="v_description"></textarea>
										</div>
									</div>
								</div>
								<hr>
