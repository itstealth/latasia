				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							...
							<form action="{{ route('store.blog') }}" method="post" enctype="multipart/form-data" class="auth-form">
								@csrf
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input type="text" name="blog_title" placeholder="Blog Title" class="form-control" id="progress-basicpill-lastname-input">
										</div>
									</div>
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input type="text" name="country" class="form-control" placeholder="Blog For Country" id="progress-basicpill-lastname-input">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input name="blog_date" type="date" id="date" class="form-control">
										</div>
									</div>
									...
									<div class="col-lg-6">
										<div class="mb-3">
											...
											<input name="blog_image" type="file" class="form-control" placeholder="" id="image">
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="form-control" id="elm1" name="blog_description"></textarea>
										</div>
									</div>
								</div>
								<hr>
