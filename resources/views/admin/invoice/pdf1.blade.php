...
<tr>
    ...
    <td width="50%">
        ...
        <div class="bank">
            ...
            <b>IBAN:</b> GB13 TCCL 0414 0411 2559 26<br>
            <b>BIC / SWIFT:</b> TCCLGB3L<br><br>

            <b>Bank:</b><br>
            THE CURRENCY CLOUD LIMITED<br>

            <b>Bank Address:</b><br>
            12 Steward Street, The Steward Building,<br>
            London, E1 6FQ, United Kingdom<br><br>

            <b>Correspondent Bank:</b> BARCLAYS BANK PLC<br>
            <b>Correspondent Code:</b> BARCGB22XXX
        </div>
    </td>

    <!-- RIGHT: COMPANY DETAILS -->
    <td width="50%" class="company">
        <b>LATASIA INTERNATIONAL SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ</b><br>
        Grzybowska 2<br>
        00-131 Warszawa<br>
        Poland<br><br>
